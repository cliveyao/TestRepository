...
<body>
	<div id="dlgregistZCList">
		<div id="tbregistZCList" style="width: 100%;height:30px;padding-top: 10px;">
			...
			<div style="float:left;padding-left: 10px;"><a class="easyui-linkbutton" href="#" data-options="iconCls: 'icon-download'" onclick="registZCList.exportZC()" plain="true">模板</a></div>
			<form id="ZCList_downLoadForm" method="post">
	...
	registZCList = {
		...
		exportZC: function () {
			$.messager.confirm("导出","确定下载部门资产模板表格吗？",function(result){
				if(result){
					$("#ZCList_downLoadForm").form('submit', {
        ...
        columns: [
                  [{
                      ...
                      formatter:function(value,row){  
                          ...
                          var content = "<span title='<div>"+value+"</div>' class='BMtip'>"+value+"</span>";  
                          return content;  
                      } 
