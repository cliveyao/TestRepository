  ...
  <div id="editYHPDialog">
   <form id="editYhpform" method="post" enctype="multipart/form-data">
		<table align="center" cellspacing="5px" style="margin-top:20px">
		  ...
		  <tr><td style="text-align: right;">持有数量：</td><td><table><tr><td><input id="updateYHPUI_num" name="num"/><td style="width:23px"></td><td style="text-align: right;">库存下限：</td><td><input id="updateYHPUI_left_limit" name="leftLimit"/><span style="color:#FF0000;margin-left: 3px;">*</span></td><tr></table></td></tr>
			...
			$("#editYhpform").form('submit',{
				...
				onSubmit: function(param){
					...
					if(valid && num-0<0){
						$.messager.progress('close');
						valid=false;
						$.messager.alert("提示","持有数量要为大于0的数字！","info");
					}
					/* if(valid && limit-num>0){
						$.messager.progress('close');
						valid=false;
