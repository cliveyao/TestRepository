...
public class WXZTActionController extends WXBaseController {
	 ...
	 * @return
	 */
	@RequestMapping("sumbitBMZCDJ.do")
	@ResponseBody
	public AjaxResultModel sumbitBMZCDJ(HttpServletRequest request, String zcdm, String zcmc, String cfdd,Integer zcLx, String cost, Integer num, String xh, String ccbh, String gzsj, String zjnx, String imgId) {
		try {
			Integer appId = getAppId(request);
			String djr = getUserId(request);
			return wxzcService.registerBMZCDJ(appId, djr, zcdm, zcmc, cfdd, zcLx, cost, num, xh, ccbh, gzsj, zjnx, imgId);
		} catch (OperException e) {
			return INVALID_TOKEN;
		}
	} 
