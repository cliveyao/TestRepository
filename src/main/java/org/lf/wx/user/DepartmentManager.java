...
public class DepartmentManager {
	 ...
	 * 获取部门成员
	 */
	public static final String SIMPLELIST = "https://qyapi.weixin.qq.com/cgi-bin/user/simplelist?access_token=%s&department_id=%s&fetch_child=%s";
	 ...
	 * @return
{
   ...
   "errmsg": "deleted"
	 ...
	 * 
	 * @param id 获取的部门id
	 * @param fetchChild 	true(1)/false(0)：是否递归获取子部门下面的成员 
	 * @return
{
   "errcode": 0,
   "errmsg": "ok",
   "userlist": [
	 ...
	 */
	public static JSONObject simpleUserList(String accessToken, int id, boolean fetchChild) throws WXException {
		String url = String.format(SIMPLELIST, accessToken, id, fetchChild ? 1 : 0);
