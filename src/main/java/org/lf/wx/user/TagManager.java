...

{
   ...
   "errmsg": "all list invalid "
	 ...
	 */
	public static boolean addTagUsers(String accessToken, int tagid, String... useridList) throws WXException {
...

{
   ...
   "errmsg": "all list invalid"
	 ...
	 * @throws WXException
	 */
	public static boolean delTagUsers(String accessToken, int tagid, String... useridList) throws WXException {
