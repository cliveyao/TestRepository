...
public class WXAppServiceTest {
	...
	@Test
	public void testSyncTag() throws Exception {
		ChuApp app = dao.getApp("ww342013a5f3df8c7f", 1000002);
		
		System.out.println(JSON.toJSON(dao.syncTag(app.getAppId())).toString());  
	}
...
//		dao.syncZTAction(app.getAppId());
		
		dao.syncChuWXUser(app.getAppId(), "shangwei");
	}
